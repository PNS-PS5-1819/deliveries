...
-i dataFilePath -o solutionFilePath
-i datafilePath -o solutionFilePath -b referenceFilePath --distance
-i dataFilePath -o --satisfaction
-i dataFilePath -o --stability
